...
const useUIStore = create<UIState>()(
    devtools((set, get) => ({
        ...
        toggleAddBoardModal: () => set((state) => ({ addBoardModalOpen: !state.addBoardModalOpen })),

        deleteBoardModalOpen: false,
        toggleDeleteBoardModal: () => set((state) => ({ deleteBoardModalOpen: !state.deleteBoardModalOpen })),
        ...
        toggleAddUserModal: () => set((state) => ({ addUserModalOpen: !state.addUserModalOpen })),

        removeUserModalOpen: false,
        toggleRemoveUserModal: (user) => set((state) => ({ focusedUser: user, removeUserModalOpen: !state.removeUserModalOpen })),

        updateUserAccessModalOpen: false,
        toggleUpdateUserAccessModal: (user) => set((state) => ({ focusedUser: user, updateUserAccessModalOpen: !state.updateUserAccessModalOpen })),

        leaveBoardModalOpen: false,
        toggleLeaveBoardModal: () => set((state) => ({ leaveBoardModalOpen: !state.leaveBoardModalOpen })),

        //Words operations
        focusedWord: null,

        addWordModalOpen: false,
        toggleAddWordModal: () => set((state) => ({ addWordModalOpen: !state.addWordModalOpen })),

        deleteWordModalOpen: false,
        toggleDeleteWordModal: (word) => set((state) => ({ focusedWord: word, deleteWordModalOpen: !state.deleteWordModalOpen })),

        editWordModalOpen: false,
        toggleEditWordModal: (word) => set((state) => ({ focusedWord: word, editWordModalOpen: !state.editWordModalOpen })),

        viewWordModalOpen: false,
        toggleViewWordModal: (word) => set((state) => ({ focusedWord: word, viewWordModalOpen: !state.viewWordModalOpen })),

        //Root Words operations
        focusedRootWord: null,

        addRootWordModalOpen: false,
        toggleAddRootWordModal: () => set((state) => ({ addRootWordModalOpen: !state.addRootWordModalOpen })),

        deleteRootWordModalOpen: false,
        toggleDeleteRootWordModal: (rootWord) => set((state) => ({ focusedRootWord: rootWord, deleteRootWordModalOpen: !state.deleteRootWordModalOpen })),

        editRootWordModalOpen: false,
        toggleEditRootWordModal: (rootWord) => set((state) => ({ focusedRootWord: rootWord, editRootWordModalOpen: !state.editRootWordModalOpen })),

        viewRootWordModalOpen: false,
        toggleViewRootWordModal: (rootWord) => set((state) => ({ focusedRootWord: rootWord, viewRootWordModalOpen: !state.viewRootWordModalOpen })),
    }))
);
