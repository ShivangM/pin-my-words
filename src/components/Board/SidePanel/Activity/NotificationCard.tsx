...
const NotificationCard = ({ notification }: Props) => {
  return (
    <div
      className="grid grid-cols-8 items-center w-full max-w-xs p-4 gap-4 text-gray-500 bg-white divide-x divide-gray-200 rounded-lg shadow"
      role="alert"
    >
      ...
      <div className="pl-4 col-span-7 text-sm font-normal">
        <time className="text-gray-900 text-xs">
