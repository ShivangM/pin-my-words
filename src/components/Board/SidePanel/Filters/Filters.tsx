...
const Filters = (props: Props) => {
  const [resetFilter, boardMode, toggleBoardMode] = useBoardStore((state) => [state.resetFilter, state.boardMode, state.toggleBoardMode]);
  ...
  return <div className='w-full space-y-4' >
    ...
    <div className="mt-4 w-full grid grid-cols-3 p-3 gap-2 ">
      ...
      >
        <span>Show {boardMode === BoardModes.WORDS ? 'Roots' : 'Words'}</span> <HiOutlineSwitchHorizontal />
      </button>
